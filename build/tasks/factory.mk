...
VENDOR_PATH := vendor/khadas/kvim
...
$(INSTALLED_AML_INSTALL_PACKAGE_TARGET): $(addprefix $(PRODUCT_OUT)/,$(NEEDED_IMAGES)) $(ACP) $(AML_IMAGE_TOOL)
	...
	$(hide) $(call aml-copy-install-file, $(VENDOR_PATH)/radio/bootloader-bl2.img, u-boot.bin.usb.bl2)
	$(hide) $(call aml-copy-install-file, $(VENDOR_PATH)/radio/bootloader-tpl.img, u-boot.bin.usb.tpl)
	...
	$(hide) $(call aml-copy-install-file, $(PRODUCT_OUT)/odm.img)
	$(hide) $(call aml-copy-install-file, $(PRODUCT_OUT)/system.img)
	$(hide) $(call aml-copy-install-file, $(PRODUCT_OUT)/vendor.img)
...
$(INSTALLED_AML_UPGRADE_PACKAGE_TARGET): $(addprefix $(PRODUCT_OUT)/,$(NEEDED_IMAGES)) $(ACP) $(AML_IMAGE_TOOL)
	...
	$(hide) $(call aml-copy-upgrade-file, $(VENDOR_PATH)/radio/bootloader-bl2.img, u-boot.bin.usb.bl2)
	$(hide) $(call aml-copy-upgrade-file, $(VENDOR_PATH)/radio/bootloader-tpl.img, u-boot.bin.usb.tpl)
